...
SETTINGS_DATA = [
    ...
    ("Enable VectorAI Backend", "vectorai_enabled",
     "When enabled, embeddings are mirrored to the external Actian VectorAI DB backend for named-vector search.",
     True,
     {"type": "bool"}),

    ("VectorAI Strict Mode", "vectorai_strict",
     "If enabled, VectorAI connection/index failures fail tasks instead of gracefully falling back to local search.",
     False,
     {"type": "bool"}),

    ("VectorAI Host", "vectorai_host",
     "VectorAI DB gRPC host name.",
     "127.0.0.1",
     {"type": "text"}),

    ("VectorAI Port", "vectorai_port",
     "VectorAI DB gRPC port.",
     50051,
     {"type": "text"}),
